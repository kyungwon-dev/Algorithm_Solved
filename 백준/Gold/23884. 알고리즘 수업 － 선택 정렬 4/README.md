# [Gold IV] 알고리즘 수업 - 선택 정렬 4 - 23884 

[문제 링크](https://www.acmicpc.net/problem/23884) 

### 성능 요약

메모리: 131856 KB, 시간: 1404 ms

### 분류

값 / 좌표 압축(coordinate_compression), 자료 구조(data_structures), 정렬(sorting), 트리를 사용한 집합과 맵(tree_set)
